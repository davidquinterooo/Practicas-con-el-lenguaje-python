"""
Práctica: Sistema de Catálogo Multimedia en Python

Descripción:
 Este script modela un catálogo multimedia administrado mediante
 Programación Orientada a Objetos (POO). Permite registrar películas y 
 series de televisión, validando los datos de cada elemento y gestionando
 errores mediante una excepción personalizada (MediaError).

Componentes clave:
 - MediaError: Excepción personalizada para errores del catálogo.
 - Movie: Clase base para películas con validación de metadatos.
 - TVSeries: Subclase especializada que extiende a Movie con temporadas y episodios.
 - MediaCatalogue: Colección que gestiona, filtra y muestra los elementos.
"""
