# Prácticas con el Lenguaje Python

¡Bienvenido a mi repositorio de prácticas y proyectos en Python! 

Este espacio está dedicado a mi aprendizaje diario del lenguaje Python. 
Aquí almaceno ejercicios, laboratorios, retos de código y proyectos 
desarrollados durante mi formación continua.

---

## Objetivos del Repositorio

- **Consistencia:** Practicar programación de forma diaria para mantener 
una racha de aprendizaje activa.
- **Dominio de Conceptos:** Aplicar desde los fundamentos básicos hasta 
temas avanzados de Programación Orientada a Objetos (POO), estructuras de 
datos y algoritmos.
- **Portafolio:** Documentar mi evolución técnica y tener un registro 
público de mi código.
...
- **Entorno de Desarrollo:** VS Code / PyCharm / Replit

---

## Proyectos y Desafíos Destacados
...
| **Sistema de Catálogo Multimedia** | Permite registrar películas y series de televisión, validando los datos de cada elemento y gestionando errores mediante una excepción personalizada | Excepciones personalizadas, Encapsulamiento y validación, Herencia e invocación de superclase Sobrescritura de métodos especiales, Polimorfismo y filtrado, Control de flujo y manejo de errores|
...
| **Paso de pruebas / Caso de prueba para merge_sort** | Probar la función merge_sort pasando arreglos con distintos casos de borde (listas vacías, con un solo elemento, con duplicados o ya ordenadas) para verificar su correcto funcionamiento. | Pruebas unitarias, Casos de borde (Edge cases), Inmutabilidad y Mutación de listas |
